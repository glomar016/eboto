                ...
                <div class="login-wrap">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="<?php echo base_url()?>user/forgotten/send_email" method="post">
                                <div class="form-group">
                                    <label>Email Address</label> 
                                    <p class="text-danger text-right"><small>Use your email that is linked to your sis account.</small></p>
